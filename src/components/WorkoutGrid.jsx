...
const WorkoutGrid = ({ workouts }) => {
    return (
        <>
            ...
            <div className="mx-auto pb-10 mt-4 grid w-full max-w-300 grid-cols-1 gap-4 rounded-xl p-3 sm:grid-cols-2 sm:gap-4 sm:p-4 lg:grid-cols-3 lg:gap-7 lg:pb-15">
